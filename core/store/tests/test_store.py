...
class StoreTests(APITestCase):
    def setUp(self):
        ...
        self.theme = StoreItem.objects.create(
            name="Dracula", cost=200, category="THEME", item_data={"theme_key": "dracula"}, icon_name="moon"
        )
        self.font = StoreItem.objects.create(
            name="Mono", cost=100, category="FONT", item_data={"font_family": "Monospace"}, icon_name="type"
        )
