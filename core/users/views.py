...
from .serializers import UserSerializer, UserSummarySerializer, FollowToggleResponseSerializer, RedeemReferralSerializer
    ...
    def get(self, request, username):
        ...
        for rel in followers:
            ...
            data.append({
                ...
                'avatar_url': (f"{settings.BACKEND_URL}{profile.avatar.url}" if profile.avatar else None) if profile else None,
                'is_following': is_following
            })
