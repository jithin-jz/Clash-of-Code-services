...
class ChallengeCoreTests(APITestCase):
    def setUp(self):
        ...
        self.c1 = Challenge.objects.create(
            title="Level 1", slug="l1", order=1, xp_reward=100, target_time_seconds=60,
            description="D1", initial_code="pass", test_code="assert True"
        )
        self.c2 = Challenge.objects.create(
            title="Level 2", slug="l2", order=2, xp_reward=200, target_time_seconds=120,
            description="D2", initial_code="pass", test_code="assert True"
        )
        self.c3 = Challenge.objects.create(
            title="Level 3", slug="l3", order=3, xp_reward=300, target_time_seconds=180,
            description="D3", initial_code="pass", test_code="assert True"
        )
