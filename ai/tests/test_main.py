...
def test_unauthorized_hints():
    response = client.post("/hints", json={"user_code": "print(1)", "challenge_slug": "test", "hint_level": 1})
...
async def test_analyze_code_success(mock_factory, mock_rag, mock_fetch):
    mock_fetch.return_value = {"title": "T", "description": "D", "initial_code": "", "test_code": ""}
